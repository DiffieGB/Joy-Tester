...
public class API_Demo : MonoBehaviour
{
    ...
    void Update()
    {
        if( screenWidth != Screen.width || screenHeight != Screen.height )
        {
            ...
            disBtnSize.x = screenWidth - ( screenWidth / 100f * 57.5f ) + 300;
            disBtnSize.y = 5f;
            disBtnSize.width = screenWidth / 100f * 15.25f;
            disBtnSize.height = screenHeight / 14f;

            hideBtnSize.x = screenWidth - ( screenWidth / 100f * 57.5f) + 300;
            ...
            //
            leftWindow.x = 5f + 300;
            rightWindow.x = screenWidth - ( screenWidth / 2.45f ) + 300;
