...
understand the folders in connection with the Simple Joystick. There are two main folder that were imported with the
Simple Joystick: Editor Default Resources, and Plugins. The Editor Default Resources folder contains all of the images,
prefabs, and other things that help the Simple Joystick be as EASY as possible to work with inside the Editor. It is
worth noting, that the files inside of this folder, will NOT be included inside of any builds of your game. They are
